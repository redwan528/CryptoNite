...
//  CryptoNite
//
//  Created by Redwan Khan on 1/19/24.
//
...
extension CoinRowsView {
    ...
    private var rightColumn: some View {
        ...
        .frame(width: UIScreen.main.bounds.width / 3.5, alignment: .trailing) // this is fine cuz our app is only in portrait mode, if it supported both landscape and portrait should use gemoetry reader
    }
}
